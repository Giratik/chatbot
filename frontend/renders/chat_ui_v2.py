...
def reset_and_rerun():
    ...
    st.session_state.excel_mode = False
    st.session_state.current_excel_file = None
    st.session_state.excel_bytes = None   # ← ajouter
    st.session_state.excel_name = None    # ← ajouter
    st.session_state.excel_sheet = None   # ← ajouter
    st.rerun()
...
def render_chat_v2(title="Chatbot EDP Hybride"):
    """
