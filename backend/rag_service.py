"""
rag_service.py — Fonctions RAG réutilisables (ChromaDB, Ollama, BM25, reranker)
Adapté depuis le fichier utilisateur `backend.py` et intégré au package `backend`.
"""
...
from backend.config import CHROMA_HOST, CHROMA_PORT, OLLAMA_HOST

# Valeur par défaut si non fournie via env
